...
var G__22160 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__22160;
continue;
} else {
return ch;
...
var vec__22161 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__22161,(0),null);
return (match === s);
});
...
var len__4499__auto___22166 = arguments.length;
var i__4500__auto___22167 = (0);
while(true){
if((i__4500__auto___22167 < len__4499__auto___22166)){
args__4502__auto__.push((arguments[i__4500__auto___22167]));

var G__22168 = (i__4500__auto___22167 + (1));
i__4500__auto___22167 = G__22168;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq22164){
...
return (function() { 
var G__22169__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__22169 = function (rdr,var_args){
var _ = null;
...
while (G__22170__i < G__22170__a.length) {G__22170__a[G__22170__i] = arguments[G__22170__i + 1]; ++G__22170__i;}
  _ = new cljs.core.IndexedSeq(G__22170__a,0,null);
} 
return G__22169__delegate.call(this,rdr,_);};
G__22169.cljs$lang$maxFixedArity = 1;
G__22169.cljs$lang$applyTo = (function (arglist__22171){
var rdr = cljs.core.first(arglist__22171);
var _ = cljs.core.rest(arglist__22171);
return G__22169__delegate(rdr,_);
});
...
//# sourceMappingURL=commons.js.map?rel=1531954885205
