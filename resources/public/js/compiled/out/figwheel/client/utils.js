...
return (new CustomEvent(event_name,(function (){var obj37265 = {"detail":data};
return obj37265;
})()));
} else {
...
var f = (function (){var pred__37272 = cljs.core._EQ_;
var expr__37273 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__37272.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__37273))){
return ((function (pred__37272,expr__37273){
return (function (p1__37266_SHARP_){
return console.warn(p1__37266_SHARP_);
});
;})(pred__37272,expr__37273))
} else {
if(cljs.core.truth_(pred__37272.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__37273))){
return ((function (pred__37272,expr__37273){
return (function (p1__37267_SHARP_){
return console.debug(p1__37267_SHARP_);
});
;})(pred__37272,expr__37273))
} else {
if(cljs.core.truth_(pred__37272.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__37273))){
return ((function (pred__37272,expr__37273){
return (function (p1__37268_SHARP_){
return console.error(p1__37268_SHARP_);
});
;})(pred__37272,expr__37273))
} else {
return ((function (pred__37272,expr__37273){
return (function (p1__37269_SHARP_){
return console.log(p1__37269_SHARP_);
});
;})(pred__37272,expr__37273))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__37276){
...
var eval_fn = cljs.core.get.call(null,map__37277__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__37279_SHARP_){
return new_def.callback(p1__37279_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__37281,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1531954930753
