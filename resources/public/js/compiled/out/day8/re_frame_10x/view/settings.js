...
day8.re_frame_10x.view.settings.closeable_text_box.cljs$core$IFn$_invoke$arity$variadic = (function (p__33672){
...
var model = cljs.core.get.call(null,map__33673__$1,new cljs.core.Keyword(null,"model","model",331153215));
var width = cljs.core.get.call(null,map__33673__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var on_close = cljs.core.get.call(null,map__33673__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var on_change = cljs.core.get.call(null,map__33673__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
/** @this {Function} */
day8.re_frame_10x.view.settings.closeable_text_box.cljs$lang$applyTo = (function (seq33671){
...
return mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","set-number-of-retained-epochs","settings/set-number-of-retained-epochs",-1910736736),p1__33678_SHARP_], null));
...
return mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","app-db-follows-events?","settings/app-db-follows-events?",-115495889),p1__33679_SHARP_], null));
...
});})(i__33686,id,item,c__4290__auto__,size__4291__auto__,b__33687,s__33685__$2,temp__4657__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__33686,id,item,c__4290__auto__,size__4291__auto__,b__33687,s__33685__$2,temp__4657__auto__){
return (function (p1__33680_SHARP_){
return mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-ignored-event","settings/update-ignored-event",-407164743),id,p1__33680_SHARP_], null));
});})(i__33686,id,item,c__4290__auto__,size__4291__auto__,b__33687,s__33685__$2,temp__4657__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__33692 = (i__33686 + (1));
i__33686 = G__33692;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__33687),day8$re_frame_10x$view$settings$render_$_iter__33684.call(null,cljs.core.chunk_rest.call(null,s__33685__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__33687),null);
}
} else {
var item = cljs.core.first.call(null,s__33685__$2);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"event-str","event-str",381347778).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"212px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (id,item,s__33685__$2,temp__4657__auto__){
return (function (){
return mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","remove-ignored-event","settings/remove-ignored-event",-391073521),id], null));
});})(id,item,s__33685__$2,temp__4657__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (id,item,s__33685__$2,temp__4657__auto__){
return (function (p1__33680_SHARP_){
return mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-ignored-event","settings/update-ignored-event",-407164743),id,p1__33680_SHARP_], null));
});})(id,item,s__33685__$2,temp__4657__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$settings$render_$_iter__33684.call(null,cljs.core.rest.call(null,s__33685__$2)));
}
} else {
return null;
}
...
})], null)], null)], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"width","width",-384071477),day8.re_frame_10x.view.settings.comp_section_width,new cljs.core.Keyword(null,"gap","gap",80255254),day8.re_frame_10x.view.settings.vertical_gap,new cljs.core.Keyword(null,"children","children",-940561982),(function (){var iter__4292__auto__ = (function day8$re_frame_10x$view$settings$render_$_iter__33688(s__33689){
return (new cljs.core.LazySeq(null,(function (){
var s__33689__$1 = s__33689;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__33689__$1);
if(temp__4657__auto__){
var s__33689__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__33689__$2)){
var c__4290__auto__ = cljs.core.chunk_first.call(null,s__33689__$2);
var size__4291__auto__ = cljs.core.count.call(null,c__4290__auto__);
var b__33691 = cljs.core.chunk_buffer.call(null,size__4291__auto__);
if((function (){var i__33690 = (0);
while(true){
if((i__33690 < size__4291__auto__)){
var item = cljs.core._nth.call(null,c__4290__auto__,i__33690);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
cljs.core.chunk_append.call(null,b__33691,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"343px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (i__33690,id,item,c__4290__auto__,size__4291__auto__,b__33691,s__33689__$2,temp__4657__auto__){
return (function (){
...
});})(i__33690,id,item,c__4290__auto__,size__4291__auto__,b__33691,s__33689__$2,temp__4657__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__33690,id,item,c__4290__auto__,size__4291__auto__,b__33691,s__33689__$2,temp__4657__auto__){
return (function (p1__33681_SHARP_){
return mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-filtered-view-trace","settings/update-filtered-view-trace",-530575796),id,p1__33681_SHARP_], null));
});})(i__33690,id,item,c__4290__auto__,size__4291__auto__,b__33691,s__33689__$2,temp__4657__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__33693 = (i__33690 + (1));
i__33690 = G__33693;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__33691),day8$re_frame_10x$view$settings$render_$_iter__33688.call(null,cljs.core.chunk_rest.call(null,s__33689__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__33691),null);
}
} else {
var item = cljs.core.first.call(null,s__33689__$2);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"343px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (id,item,s__33689__$2,temp__4657__auto__){
return (function (){
return mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","remove-filtered-view-trace","settings/remove-filtered-view-trace",970685301),id], null));
});})(id,item,s__33689__$2,temp__4657__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (id,item,s__33689__$2,temp__4657__auto__){
return (function (p1__33681_SHARP_){
return mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-filtered-view-trace","settings/update-filtered-view-trace",-530575796),id,p1__33681_SHARP_], null));
});})(id,item,s__33689__$2,temp__4657__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$settings$render_$_iter__33688.call(null,cljs.core.rest.call(null,s__33689__$2)));
}
} else {
return null;
}
...
return mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","low-level-trace","settings/low-level-trace",191054289),new cljs.core.Keyword(null,"reagent","reagent",2131627322),p1__33682_SHARP_], null));
});})(low_level_trace))
...
//# sourceMappingURL=settings.js.map?rel=1531954922973
