...
day8.re_frame_10x.view.components.search_input = (function day8$re_frame_10x$view$components$search_input(p__33496){
...
var title = cljs.core.get.call(null,map__33497__$1,new cljs.core.Keyword(null,"title","title",636505583));
var placeholder = cljs.core.get.call(null,map__33497__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var on_save = cljs.core.get.call(null,map__33497__$1,new cljs.core.Keyword(null,"on-save","on-save",1618176266));
var on_change = cljs.core.get.call(null,map__33497__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var on_stop = cljs.core.get.call(null,map__33497__$1,new cljs.core.Keyword(null,"on-stop","on-stop",1520114515));
var val = mranderson048.reagent.v0v7v0.reagent.core.atom.call(null,title);
var save = ((function (val,map__33497,map__33497__$1,title,placeholder,on_save,on_change,on_stop){
return (function (){
...
day8.re_frame_10x.view.components.autoscroll_list = (function day8$re_frame_10x$view$components$autoscroll_list(p__33501,child){
...
var class$ = cljs.core.get.call(null,map__33502__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var scroll_QMARK_ = cljs.core.get.call(null,map__33502__$1,new cljs.core.Keyword(null,"scroll?","scroll?",-1393045951));
...
return mranderson048.reagent.v0v7v0.reagent.core.create_class.call(null,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"display-name","display-name",694513143),"autoscroll-list",new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),((function (node,should_scroll,map__33502,map__33502__$1,class$,scroll_QMARK_){
return (function (_){
...
});})(node,should_scroll,map__33502,map__33502__$1,class$,scroll_QMARK_))
,new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),((function (node,should_scroll,map__33502,map__33502__$1,class$,scroll_QMARK_){
return (function (_){
...
,new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),((function (node,should_scroll,map__33502,map__33502__$1,class$,scroll_QMARK_){
return (function (_){
...
,new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),((function (node,should_scroll,map__33502,map__33502__$1,class$,scroll_QMARK_){
return (function (p__33504,child__$1){
...
var class$__$1 = cljs.core.get.call(null,map__33505__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),class$__$1,new cljs.core.Keyword(null,"ref","ref",1289896967),((function (map__33505,map__33505__$1,class$__$1,node,should_scroll,map__33502,map__33502__$1,class$,scroll_QMARK_){
return (function (dom_node){
return cljs.core.reset_BANG_.call(null,node,dom_node);
});})(map__33505,map__33505__$1,class$__$1,node,should_scroll,map__33502,map__33502__$1,class$,scroll_QMARK_))
], null),child__$1], null);
});})(node,should_scroll,map__33502,map__33502__$1,class$,scroll_QMARK_))
], null));
});
...
return cljs.core.reduce.call(null,(function (acc,p__33508){
var vec__33509 = p__33508;
var property = cljs.core.nth.call(null,vec__33509,(0),null);
var value = cljs.core.nth.call(null,vec__33509,(1),null);
return cljs.core.assoc.call(null,acc,cljs.core.keyword.call(null,property),value);
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p1__33507_SHARP_){
return clojure.string.split.call(null,p1__33507_SHARP_,/:/);
...
var len__4499__auto___33514 = arguments.length;
var i__4500__auto___33515 = (0);
while(true){
if((i__4500__auto___33515 < len__4499__auto___33514)){
args__4502__auto__.push((arguments[i__4500__auto___33515]));

var G__33516 = (i__4500__auto___33515 + (1));
i__4500__auto___33515 = G__33516;
continue;
} else {
}
break;
...
var previous_config__33485__auto__ = devtools.prefs.get_prefs.call(null);
var prefs__33486__auto__ = day8.re_frame_10x.view.components.effective_cljs_devtools_prefs;
try{devtools.prefs.set_prefs_BANG_.call(null,prefs__33486__auto__);

return cljs.core.apply.call(null,api_fn,args);
}finally {if(cljs.core._EQ_.call(null,devtools.prefs.get_prefs.call(null),prefs__33486__auto__)){
} else {
throw (new Error(["Assert failed: ","someone modified devtools.prefs behind our back!","\n","(clojure.core/= (devtools.prefs/get-prefs) prefs__33486__auto__)"].join('')));
}

devtools.prefs.set_prefs_BANG_.call(null,previous_config__33485__auto__);
}});

day8.re_frame_10x.view.components.make_devtools_api_call.cljs$lang$maxFixedArity = (1);

/** @this {Function} */
day8.re_frame_10x.view.components.make_devtools_api_call.cljs$lang$applyTo = (function (seq33512){
var G__33513 = cljs.core.first.call(null,seq33512);
var seq33512__$1 = cljs.core.next.call(null,seq33512);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33513,seq33512__$1);
});
...
/** @this {Function} */
day8.re_frame_10x.view.components.cljs_devtools_header.cljs$lang$applyTo = (function (seq33517){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq33517));
});
...
var args__4502__auto__ = [];
var len__4499__auto___33522 = arguments.length;
var i__4500__auto___33523 = (0);
while(true){
if((i__4500__auto___33523 < len__4499__auto___33522)){
args__4502__auto__.push((arguments[i__4500__auto___33523]));

var G__33524 = (i__4500__auto___33523 + (1));
i__4500__auto___33523 = G__33524;
continue;
} else {
}
break;
...
/** @this {Function} */
day8.re_frame_10x.view.components.cljs_devtools_body.cljs$lang$applyTo = (function (seq33521){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq33521));
});
...
/** @this {Function} */
day8.re_frame_10x.view.components.cljs_devtools_has_body.cljs$lang$applyTo = (function (seq33525){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq33525));
});
...
day8.re_frame_10x.view.components.simple_render.cljs$core$IFn$_invoke$arity$variadic = (function (data,path,p__33535){
var vec__33536 = p__33535;
var class$ = cljs.core.nth.call(null,vec__33536,(0),null);
var expanded_QMARK_ = mranderson048.reagent.v0v7v0.reagent.core.atom.call(null,true);
return ((function (expanded_QMARK_,vec__33536,class$){
return (function (data__$1){
...
;})(expanded_QMARK_,vec__33536,class$))
});

day8.re_frame_10x.view.components.simple_render.cljs$lang$maxFixedArity = (2);

/** @this {Function} */
day8.re_frame_10x.view.components.simple_render.cljs$lang$applyTo = (function (seq33532){
var G__33533 = cljs.core.first.call(null,seq33532);
var seq33532__$1 = cljs.core.next.call(null,seq33532);
var G__33534 = cljs.core.first.call(null,seq33532__$1);
var seq33532__$2 = cljs.core.next.call(null,seq33532__$1);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33533,G__33534,seq33532__$2);
});
...
//# sourceMappingURL=components.js.map?rel=1531954921756
