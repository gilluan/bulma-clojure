...
var len__4499__auto___31115 = arguments.length;
var i__4500__auto___31116 = (0);
while(true){
if((i__4500__auto___31116 < len__4499__auto___31115)){
args__4502__auto__.push((arguments[i__4500__auto___31116]));

var G__31117 = (i__4500__auto___31116 + (1));
i__4500__auto___31116 = G__31117;
continue;
} else {
}
break;
...
return clojure.zip.edit.call(null,zloc,rewrite_clj.zip.editz.edit_node,(function (p1__31111_SHARP_){
return cljs.core.apply.call(null,f,p1__31111_SHARP_,args);
}));
});
...
/** @this {Function} */
rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq31112){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31113,G__31114,seq31112__$2);
});
...
var G__31120 = rewrite_clj.zip.base.tag.call(null,zloc);
var G__31120__$1 = (((G__31120 instanceof cljs.core.Keyword))?G__31120.fqn:null);
switch (G__31120__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token.call(null,zloc,((function (G__31120,G__31120__$1){
return (function (p1__31118_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__31118_SHARP_)].join('');
});})(G__31120,G__31120__$1))
);

break;
case "multi-line":
return rewrite_clj.zip.editz.edit_multi_line.call(null,zloc,((function (G__31120,G__31120__$1){
return (function (lines){
if(cljs.core.empty_QMARK_.call(null,lines)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [s], null);
} else {
return cljs.core.update_in.call(null,lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),((function (G__31120,G__31120__$1){
return (function (p1__31119_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__31119_SHARP_)].join('');
});})(G__31120,G__31120__$1))
);
}
});})(G__31120,G__31120__$1))
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__31120__$1)].join('')));

}
});
rewrite_clj.zip.editz.suffix = (function rewrite_clj$zip$editz$suffix(zloc,s){
var G__31123 = rewrite_clj.zip.base.tag.call(null,zloc);
var G__31123__$1 = (((G__31123 instanceof cljs.core.Keyword))?G__31123.fqn:null);
switch (G__31123__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token.call(null,zloc,((function (G__31123,G__31123__$1){
return (function (p1__31122_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__31122_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
});})(G__31123,G__31123__$1))
);

break;
case "multi-line":
return rewrite_clj.zip.editz.edit_multi_line.call(null,zloc,((function (G__31123,G__31123__$1){
return (function (lines){
if(cljs.core.empty_QMARK_.call(null,lines)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [s], null);
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__31123__$1)].join('')));

}
});

//# sourceMappingURL=editz.js.map?rel=1531954912760
