...
rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4174__auto__,k29016,else__4175__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k29016,else__4175__auto__);
...
rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__29015){
var self__ = this;
var G__29015__$1 = this;
return (new cljs.core.RecordIter((0),G__29015__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this29017,other29018){
var self__ = this;
var this29017__$1 = this;
return ((!((other29018 == null))) && ((this29017__$1.constructor === other29018.constructor)) && (cljs.core._EQ_.call(null,this29017__$1.whitespace,other29018.whitespace)) && (cljs.core._EQ_.call(null,this29017__$1.__extmap,other29018.__extmap)));
});
...
rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4179__auto__,k__4180__auto__,G__29015){
var self__ = this;
var this__4179__auto____$1 = this;
var pred__29021 = cljs.core.keyword_identical_QMARK_;
var expr__29022 = k__4180__auto__;
if(cljs.core.truth_(pred__29021.call(null,new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483),expr__29022))){
return (new rewrite_clj.node.whitespace.WhitespaceNode(G__29015,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.whitespace.WhitespaceNode(self__.whitespace,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4180__auto__,G__29015),null));
}
});
...
rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4171__auto__,G__29015){
var self__ = this;
var this__4171__auto____$1 = this;
return (new rewrite_clj.node.whitespace.WhitespaceNode(self__.whitespace,G__29015,self__.__extmap,self__.__hash));
});
 ...
 */
rewrite_clj.node.whitespace.map__GT_WhitespaceNode = (function rewrite_clj$node$whitespace$map__GT_WhitespaceNode(G__29019){
return (new rewrite_clj.node.whitespace.WhitespaceNode(new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483).cljs$core$IFn$_invoke$arity$1(G__29019),null,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,G__29019,new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483))),null));
});
...
rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4174__auto__,k29026,else__4175__auto__){
var self__ = this;
var this__4174__auto____$1 = this;
var G__29030 = k29026;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k29026,else__4175__auto__);
...
rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__29025){
var self__ = this;
var G__29025__$1 = this;
return (new cljs.core.RecordIter((0),G__29025__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"newlines","newlines",-1185451518)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this29027,other29028){
var self__ = this;
var this29027__$1 = this;
return ((!((other29028 == null))) && ((this29027__$1.constructor === other29028.constructor)) && (cljs.core._EQ_.call(null,this29027__$1.newlines,other29028.newlines)) && (cljs.core._EQ_.call(null,this29027__$1.__extmap,other29028.__extmap)));
});
...
rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4179__auto__,k__4180__auto__,G__29025){
var self__ = this;
var this__4179__auto____$1 = this;
var pred__29031 = cljs.core.keyword_identical_QMARK_;
var expr__29032 = k__4180__auto__;
if(cljs.core.truth_(pred__29031.call(null,new cljs.core.Keyword(null,"newlines","newlines",-1185451518),expr__29032))){
return (new rewrite_clj.node.whitespace.NewlineNode(G__29025,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.whitespace.NewlineNode(self__.newlines,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4180__auto__,G__29025),null));
}
});
...
rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4171__auto__,G__29025){
var self__ = this;
var this__4171__auto____$1 = this;
return (new rewrite_clj.node.whitespace.NewlineNode(self__.newlines,G__29025,self__.__extmap,self__.__hash));
});
 ...
 */
rewrite_clj.node.whitespace.map__GT_NewlineNode = (function rewrite_clj$node$whitespace$map__GT_NewlineNode(G__29029){
return (new rewrite_clj.node.whitespace.NewlineNode(new cljs.core.Keyword(null,"newlines","newlines",-1185451518).cljs$core$IFn$_invoke$arity$1(G__29029),null,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,G__29029,new cljs.core.Keyword(null,"newlines","newlines",-1185451518))),null));
});
...
var comma_29035 = rewrite_clj.node.whitespace.whitespace_node.call(null,", ");
/**
 * Interleave the given seq of nodes with `", "` nodes.
 */
rewrite_clj.node.whitespace.comma_separated = ((function (comma_29035){
return (function rewrite_clj$node$whitespace$comma_separated(nodes){
return cljs.core.butlast.call(null,cljs.core.interleave.call(null,nodes,cljs.core.repeat.call(null,comma_29035)));
});})(comma_29035))
;
var nl_29036 = rewrite_clj.node.whitespace.newline_node.call(null,"\n");
/**
 * Interleave the given seq of nodes with newline nodes.
 */
rewrite_clj.node.whitespace.line_separated = ((function (nl_29036){
return (function rewrite_clj$node$whitespace$line_separated(nodes){
return cljs.core.butlast.call(null,cljs.core.interleave.call(null,nodes,cljs.core.repeat.call(null,nl_29036)));
});})(nl_29036))
;
var space_29037 = rewrite_clj.node.whitespace.whitespace_node.call(null," ");
/**
 * Interleave the given seq of nodes with `" "` nodes.
 */
rewrite_clj.node.whitespace.space_separated = ((function (space_29037){
return (function rewrite_clj$node$whitespace$space_separated(nodes){
return cljs.core.butlast.call(null,cljs.core.interleave.call(null,nodes,cljs.core.repeat.call(null,space_29037)));
});})(space_29037))
;
/**
...
//# sourceMappingURL=whitespace.js.map?rel=1531954902862
