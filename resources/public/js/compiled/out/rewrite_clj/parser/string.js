...
if((c === "\n")){
var G__29240 = escape_QMARK_;
var G__29241 = rewrite_clj.parser.string.flush_into.call(null,lines,buf);
escape_QMARK_ = G__29240;
lines = G__29241;
continue;
} else {
buf.append(c);

var G__29242 = ((!(escape_QMARK_)) && ((c === "\\")));
var G__29243 = lines;
escape_QMARK_ = G__29242;
lines = G__29243;
continue;
...
//# sourceMappingURL=string.js.map?rel=1531954904546
