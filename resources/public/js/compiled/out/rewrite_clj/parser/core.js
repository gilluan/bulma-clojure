...
return rewrite_clj.reader.read_repeatedly.call(null,reader,(function (p1__29246_SHARP_){
var _STAR_delimiter_STAR_29247 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
rewrite_clj.parser.core._STAR_delimiter_STAR_ = delimiter;

try{return rewrite_clj.parser.core.parse_next.call(null,p1__29246_SHARP_);
}finally {rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR_29247;
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__4502__auto__ = [];
var len__4499__auto___29256 = arguments.length;
var i__4500__auto___29257 = (0);
while(true){
if((i__4500__auto___29257 < len__4499__auto___29256)){
args__4502__auto__.push((arguments[i__4500__auto___29257]));

var G__29258 = (i__4500__auto___29257 + (1));
i__4500__auto___29257 = G__29258;
continue;
} else {
}
break;
...
rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__29252){
var vec__29253 = p__29252;
var ignore_QMARK_ = cljs.core.nth.call(null,vec__29253,(0),null);
...
/** @this {Function} */
rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq29248){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29249,G__29250,G__29251,seq29248__$3);
});
...
return cljs.core.cons.call(null,(function (){var G__29259 = rewrite_clj.reader.peek.call(null,reader);
switch (G__29259) {
case "(":
...
var G__29261 = cljs.tools.reader.reader_types.peek_char.call(null,reader);
if(cljs.core._EQ_.call(null,null,G__29261)){
return rewrite_clj.reader.throw_reader.call(null,reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.call(null,"{",G__29261)){
...
if(cljs.core._EQ_.call(null,"_",G__29261)){
...
//# sourceMappingURL=core.js.map?rel=1531954904649
