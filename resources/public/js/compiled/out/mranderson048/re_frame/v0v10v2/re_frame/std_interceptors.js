...
var vec__29895_29898 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_29899 = cljs.core.nth.call(null,vec__29895_29898,(0),null);
var only_after_29900 = cljs.core.nth.call(null,vec__29895_29898,(1),null);
var db_changed_QMARK__29901 = ((!((only_before_29899 == null))) || (!((only_after_29900 == null))));
if(db_changed_QMARK__29901){
...
mranderson048.re_frame.v0v10v2.re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_29899);

mranderson048.re_frame.v0v10v2.re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_29900);
...
var map__29902 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__29902__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__29902__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__29904 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__29904__$1;
var event = cljs.core.get.call(null,map__29904__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
/** @this {Function} */
mranderson048.re_frame.v0v10v2.re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq29906){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq29906));
});
...
return cljs.core.get_in.call(null,new_db,p1__29910_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__29911_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__29911_SHARP_);
...
/** @this {Function} */
mranderson048.re_frame.v0v10v2.re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq29912){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29913,G__29914,seq29912__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1531954907851
