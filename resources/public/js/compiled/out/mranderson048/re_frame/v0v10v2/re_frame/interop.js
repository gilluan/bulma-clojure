...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__29841 = cljs.core.instance_QMARK_;
var expr__29842 = reactive_val;
if(cljs.core.truth_(pred__29841.call(null,mranderson048.reagent.v0v7v0.reagent.ratom.RAtom,expr__29842))){
return "ra";
} else {
if(cljs.core.truth_(pred__29841.call(null,mranderson048.reagent.v0v7v0.reagent.ratom.RCursor,expr__29842))){
return "rc";
} else {
if(cljs.core.truth_(pred__29841.call(null,mranderson048.reagent.v0v7v0.reagent.ratom.Reaction,expr__29842))){
return "rx";
} else {
if(cljs.core.truth_(pred__29841.call(null,mranderson048.reagent.v0v7v0.reagent.ratom.Track,expr__29842))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1531954907464
