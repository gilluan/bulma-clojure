...
var o28392 = temp__4655__auto__;
var temp__4655__auto____$1 = (o28392["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o28393 = temp__4655__auto____$1;
return (o28393["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27536__auto__ = f;
return (o__27536__auto__["toString"]).call(o__27536__auto__);
} else {
return "";
}
}catch (e28394){var _ = e28394;
return "";
}});
...
try{var o__27536__auto___28396 = t;
(o__27536__auto___28396["cljs$lang$ctorPrWriter"]).call(o__27536__auto___28396,t,writer);
}catch (e28395){var __28397 = e28395;
}
...
var char_code = (function (){var o__27536__auto__ = (new String(char$));
return (o__27536__auto__["charCodeAt"]).call(o__27536__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27536__auto__ = String;
return (o__27536__auto__["fromCharCode"]).call(o__27536__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28398 = num_code;
switch (G__28398) {
case (1):
return (185);
...
var o__27536__auto__ = String;
return (o__27536__auto__["fromCharCode"]).call(o__27536__auto__,superscript_code);
});
/**
...
}catch (e28400){var _e__27543__auto__ = e28400;
return false;
}})())){
...
var vec__28401 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__28401,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o28404 = temp__4655__auto__;
var temp__4655__auto____$1 = (o28404["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o28405 = temp__4655__auto____$1;
return (o28405["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___28412 = arguments.length;
var i__4500__auto___28413 = (0);
while(true){
if((i__4500__auto___28413 < len__4499__auto___28412)){
args__4502__auto__.push((arguments[i__4500__auto___28413]));

var G__28414 = (i__4500__auto___28413 + (1));
i__4500__auto___28413 = G__28414;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28408){
var vec__28409 = p__28408;
var ns_detector = cljs.core.nth.call(null,vec__28409,(0),null);
...
var G__28415 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__28416 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__28415;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28406){
var G__28407 = cljs.core.first.call(null,seq28406);
var seq28406__$1 = cljs.core.next.call(null,seq28406);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28407,seq28406__$1);
});
...
var vec__28420 = cljs.core.split_with.call(null,(function (p1__28419_SHARP_){
return cljs.core.not_EQ_.call(null,p1__28419_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__28420,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__28420,(1),null);
...
var vec__28423 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__28423,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__28423,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__28426 = cljs.core.rest.call(null,remaining_tokens);
var G__28427 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__28426;
name_tokens = G__28427;
continue;
} else {
...
var vec__28430 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__28430,(0),null);
var arity = cljs.core.nth.call(null,vec__28430,(1),null);
var vec__28433 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__28433,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__28433,(1),null);
var vec__28436 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__28436,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__28436,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__28436,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__28436,(3),null);
...
var munged_ns = cljs.core.nth.call(null,vec__28442,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__28442,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__28442,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__28442,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__28442,(4),null);
var arity = cljs.core.nth.call(null,vec__28442,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__28446 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__28446,(0),null);
var args = cljs.core.nth.call(null,vec__28446,(1),null);
var vec__28449 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__28449,(0),null);
var name = cljs.core.nth.call(null,vec__28449,(1),null);
...
var G__28452 = (arity + (1));
var G__28453 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28454){
var vec__28455 = p__28454;
var arity = cljs.core.nth.call(null,vec__28455,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__28455,(1),null);
...
return cljs.core.get.call(null,arities,p1__28458_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__28459_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___28466 = arguments.length;
var i__4500__auto___28467 = (0);
while(true){
if((i__4500__auto___28467 < len__4499__auto___28466)){
args__4502__auto__.push((arguments[i__4500__auto___28467]));

var G__28468 = (i__4500__auto___28467 + (1));
i__4500__auto___28467 = G__28468;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28462){
var vec__28463 = p__28462;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__28463,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28460){
var G__28461 = cljs.core.first.call(null,seq28460);
var seq28460__$1 = cljs.core.next.call(null,seq28460);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28461,seq28460__$1);
});
...
var G__28469 = arg;
var G__28469__$1 = (((G__28469 instanceof cljs.core.Keyword))?G__28469.fqn:null);
switch (G__28469__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__28471__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__28471__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__28471__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__28471__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28472 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__28472,(0),null);
var fn_name = cljs.core.nth.call(null,vec__28472,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__28472,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__28472,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__28472,(4),null);
var arity = cljs.core.nth.call(null,vec__28472,(5),null);
...
var o__27536__auto__ = f;
return (o__27536__auto__["getBasis"]).call(o__27536__auto__);
});
/**
...
}catch (e28476){var _e__27543__auto__ = e28476;
...
var G__28477 = (obj[cljs.core.first.call(null,path)]);
var G__28478 = cljs.core.rest.call(null,path);
obj = G__28477;
path = G__28478;
continue;
} else {
...
return (function (accum,p__28479){
var vec__28480 = p__28479;
var bit = cljs.core.nth.call(null,vec__28480,(0),null);
var protocol = cljs.core.nth.call(null,vec__28480,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28483){
...
var selector = cljs.core.nth.call(null,vec__28484,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__28489,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__28489,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__28489,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__28487_SHARP_){
return (obj[cljs.core.first.call(null,p1__28487_SHARP_)]);
});})(name,sorted_matches,vec__28489,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1531954900551
